namespace dotPeekser.Solr.ManagedSchema.Tests
{
    ...
    using dotPeekser.Solr.ManagedSchema.Tests.Models;
    using dotPeekser.Solr.ManagedSchemaTests.Factories;
    using dotPeekser.Solr.ManagedSchemaTests.Logging;
    using dotPeekser.Solr.ManagedSchemaTests.Serializer;
